    ...
    else // 登录成功
    {
        ...
        if (responsejs.contains("friends"))
        {
            ...
            for (string &str : vec)
            {
                ...
                user.setState(StringToUserState(js["state"]));
...
void showCurrentUserData()
{
    ...
    if (!g_currentUserFriendList.empty())
    {
        ...
        {
            cout << user.getId() << " " << user.getName() << " " << UserStateToString(user.getState())<< endl;
        }
    }
    ...
    if (!g_currentUserGroupList.empty())
    {
        for (Group &group : g_currentUserGroupList)
        {
            ...
            {
                cout << user.getId() << " " << user.getName() << " " << UserStateToString(user.getState())
                     << " " << user.getRole() << endl;
            }
        }
    }
